  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      ...
      case 3:
        ...
        break;
      case 4:
        text = Text('Çrş', style: style);
        break;
      case 5:
        text = Text('Prş', style: style);
        break;
      case 6:
        text = Text('Cum', style: style);
        break;
      case 7:
        text = Text('Cts', style: style);
        break;
      default:
        text = const Text('');
        break;
