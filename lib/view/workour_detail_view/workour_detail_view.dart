...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  List youArr = [
    {"image": "assets/icons/barbell.png", "title": "Dumb-Bell"},
    {"image": "assets/icons/skipping_rope.png", "title": "Atlama ipi"},
    {"image": "assets/icons/bottle.png", "title": "Şişe Su 1 Litre"},
  ];
  ...
  List exercisesArr = [
    {
      "name": "Set 1",
      "set": [
        {"image": "assets/images/img_1.png", "title": "Isınma", "value": "05:00"},
        {
              ...
              children: [
                ...
                SafeArea(
                  child: Column(
                    ...
                    children: [
                      RoundGradientButton(title: "Antrenmana Başla", onPressed: () {})
                    ],
                  ),
                )
              ],
